"""
Django settings for saturchat project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-jodj8dry*u5!%v5hp(z%(-q97ympyj*ish13=@y37^nabf!w#w')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'saturchat'),
...
# Site ID (needed for django-allauth)
SITE_ID = 1
